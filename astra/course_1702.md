...
**Для каталогов права:**
r - список файлов
w - создание удаление файла в каталоге
x - позволяет зайти в каталог

**Спецбиты:**
- SUID - выполнение с правами владельца файла
- SGID - выполнение с правами главной группы файла
- Sticky bit - назначается для общих папок. Все юзеры смогут создавать файлы в папке, а удалять только владельцы.
